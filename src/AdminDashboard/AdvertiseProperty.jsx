...
const AdvertiseProperty = () => {
    ...
    const [advertisement, refetch] = useAdvertisement();
    ...
    return (
        <div className="lg:px-5">
            <Helmet>
                <title>DreamDwell | Advertise</title>
            </Helmet>
            ...
            <p className="text-lg mb-4">Total Advertisement: {advertisement.length}</p>
            ...
            <div className="border-2 border-green-700 p-4 grid md:grid-cols-2 gap-6">
                {
                    properties.map((property, idx) => <div key={idx} className="p-4 border flex flex-col justify-between">
                        ...
                        {
                            advertisement.find(advertise => advertise._id == property._id) ?
                                <div className="text-center flex gap-4 justify-center mt-6">
                                    <button onClick={() => handleAdvertise(property)} className="text-gray-500 bg-gray-400 rounded-md p-2" disabled>Advertise</button>
                                ...
                                <div className="text-center flex gap-4 justify-center mt-6">
                                    ...
                                    <button onClick={() => handleRemove(property)} className="text-gray-500 bg-gray-400 rounded-md p-2" disabled>Remove Advertise</button>
                                </div>
                        }
